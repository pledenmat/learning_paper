...
lwd_trace <- 3
plot(results_saved$param_iter$alpha,type='l',col=col_low,lwd=lwd_trace,
     ylim=c(0,50),xlab="Time (trials)",ylab="Alpha")
...
cross_entropy(y,model_nolinear(x,c(results_saved$w[1],beta,1)))
